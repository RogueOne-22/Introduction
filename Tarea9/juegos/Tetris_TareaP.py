...
pygame.init()
pygame.display.set_caption("Tetris P")
...
FORMAS = [
    ...
    [[6, 6, 6], [0, 6, 0]],                 # L
    [[7, 7, 7], [7, 0, 0]],                 # J
    [[8, 8, 0], [0, 8, 8]],                 # S invertida
    [[9, 0, 0], [9, 9, 9]],                 # J rotada
    [[0, 10, 0], [10, 10, 10], [0, 10, 0]], # Estrella
    [[11, 11, 11], [0, 0, 11]],             
]
...
def dibujar_ventana(ventana, grid, pieza_actual, siguiente_pieza, puntuacion, nivel):
    ...
    pygame.draw.rect(ventana, (200, 200, 200), (0, 0, COLUMNAS*TAMANO_BLOQUE, FILAS*TAMANO_BLOQUE), 4)
    ...
    for i, linea in enumerate(controles):
        ...
        ventana.blit(texto, (ANCHO - 180, 250 + i*25))
    ...
    while ejecutando:
        ...
        for evento in pygame.event.get():
            ...
            if evento.type == pygame.KEYDOWN:
                ...
                if evento.key == pygame.K_LCTRL or evento.key == pygame.K_RCTRL:
                    reiniciar = True
                    ejecutando = False
        ...
        if pausado:
            ...
            texto_pausa = fuente.render("PAUSADO", True, (255, 255, 255))
            ventana.blit(texto_pausa, (ANCHO//2 - 100, ALTO//2))
            pygame.display.update()
            continue
